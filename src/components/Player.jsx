...
const Player = ({ audioScr, songCover, isDisplay, setIsDisplay }) => {
  ...
  return (
    <div
  className={`bg-gray-400 border border-red-500 h-[350px] w-[400px] rounded-md overflow-hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${
